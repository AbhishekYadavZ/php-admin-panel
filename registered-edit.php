                                                ...
                                                foreach($query_run as $row)
                                                {
                                                    ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" name="email" value="<?php echo $row['email']; ?>" class="form-control" placeholder="Enter Your Valid Email ID">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="">Phone</label>
                                                            <input type="text" name="phone" value="<?php echo $row['phone']; ?>" class="form-control" placeholder="Enter Your Valid Phone Number">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="">Password</label>
                                                            <input type="passowrd" name="password" value="<?php echo $row['password']; ?>" class="form-control" placeholder="Enter Your Password">
                                                        </div>
                                                        <div class="form-group">
